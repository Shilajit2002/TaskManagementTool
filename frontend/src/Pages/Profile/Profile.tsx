...
function Profile() {
  return (
    <>
      <div className="flex items-center justify-center w-5/6 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded">
          <div className="relative">
            ...
            />
            <div className="inset-0 m-auto w-24 h-24 absolute bottom-0 -mb-12 xl:ml-10 bg-white rounded-full shadow-2xl border-2">
              <img
